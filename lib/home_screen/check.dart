                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: _selectedMonth == _months[index][1] ? Colors.blue.shade100.withOpacity(0.5) : Colors.blue.withOpacity(0),
                            border: Border.all(
                              color: _selectedMonth  == _months[index][1] ? Colors.blue : Colors.white.withOpacity(0),
                              width: 1.5,
                            ),
                          ),
                          child: Column(
