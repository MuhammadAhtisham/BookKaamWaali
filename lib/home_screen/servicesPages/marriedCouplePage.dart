...
class MarriedCouplePage extends StatefulWidget {
  String service;
  int additionalPrice;
  MarriedCouplePage({Key? key, required this.service, required this.additionalPrice}) : super(key: key);

  @override
  State<MarriedCouplePage> createState() => _MarriedCouplePageState();
}

class _MarriedCouplePageState extends State<MarriedCouplePage> {
  @override
  List<dynamic> _quantity =[
    ['Team', 'https://img.icons8.com/color/512/user-group-man-woman.png', Colors.red, 0],
    ['Driver', 'https://img.icons8.com/color/2x/taxi.png', Colors.orange, 0],
    ['home care', 'https://img.icons8.com/color/2x/home.png', Colors.purple, 0],
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: _selectedquantity.length > 0 ? FloatingActionButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => Frequency(service: widget.service, gender: "male", allServices: coupleType, additionalPrice: widget.additionalPrice)),);
          },
          child: Row(
