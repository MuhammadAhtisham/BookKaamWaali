...
class WashPage extends StatefulWidget {
  ...
  int additionalPrice;
  WashPage({Key? key, required this.service, required this.allServices, required this.additionalPrice}) : super(key: key);
...
class _WashPageState extends State<WashPage> {
  ...
  List<dynamic> _quantity =[
    ['Launderer', 'https://img.icons8.com/color/512/cook-male--v1.png', Colors.red, 0],
    ['Laundress', 'https://img.icons8.com/color/2x/cook-female.png', Colors.orange, 0],
  ];
